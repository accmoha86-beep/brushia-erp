...
-- Uses ONLY columns verified in migration 001 + ALTER TABLE IF NOT EXISTS for safety

-- Ensure extra columns exist (in case earlier ALTER migrations failed/weren't applied)
...
-- ═══════════════════════════════════════════════════════
-- PRODUCTS (24 Brushia products) — only 001 columns
-- ═══════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════
-- CHART OF ACCOUNTS (use tenant_id+account_number for conflict)
-- ═══════════════════════════════════════════════════════
INSERT INTO accounting.chart_of_accounts (id, tenant_id, account_number, name, name_ar, account_type, parent_id, is_system, is_active, currency) VALUES
  ...
  ('40000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', '1100', 'Cash and Bank', 'النقدية والبنوك', 'asset', NULL, false, true, 'EGP'),
  ('40000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', '1200', 'Accounts Receivable', 'ذمم مدينة', 'asset', NULL, false, true, 'EGP'),
  ('40000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', '1300', 'Inventory', 'المخزون', 'asset', NULL, true, true, 'EGP'),
  ...
  ('40000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', '2100', 'Accounts Payable', 'ذمم دائنة', 'liability', NULL, false, true, 'EGP'),
  ('40000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000001', '2200', 'VAT Payable 14%', 'ضريبة القيمة المضافة', 'liability', NULL, true, true, 'EGP'),
  ...
  ('40000000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000001', '3100', 'Owner Capital', 'رأس المال', 'equity', NULL, false, true, 'EGP'),
  ('40000000-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000001', '3200', 'Retained Earnings', 'أرباح محتجزة', 'equity', NULL, true, true, 'EGP'),
  ...
  ('40000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000001', '4100', 'Sales Revenue', 'إيرادات المبيعات', 'revenue', NULL, true, true, 'EGP'),
  ...
  ('40000000-0000-0000-0000-000000000014', 'a0000000-0000-0000-0000-000000000001', '5100', 'COGS Products', 'تكلفة المنتجات', 'expense', NULL, true, true, 'EGP'),
  ...
  ('40000000-0000-0000-0000-000000000016', 'a0000000-0000-0000-0000-000000000001', '6100', 'Rent Expense', 'مصاريف إيجار', 'expense', NULL, false, true, 'EGP'),
  ('40000000-0000-0000-0000-000000000017', 'a0000000-0000-0000-0000-000000000001', '6200', 'Salaries and Wages', 'رواتب وأجور', 'expense', NULL, false, true, 'EGP'),
  ('40000000-0000-0000-0000-000000000018', 'a0000000-0000-0000-0000-000000000001', '6300', 'Shipping Costs', 'مصاريف شحن', 'expense', NULL, false, true, 'EGP')
ON CONFLICT (tenant_id, account_number) DO NOTHING;

-- Set code = account_number for any accounts missing code
